...
var colorD = ["#05aba2", "#a8feb7", "#fe32e8", "#bfc0ea", "#eab739", "#b56520", "#8c68be", "#fffc77", "#a77f54", "#8659fe", "#ff7ae3", "#9ed5bb", "#09c68b", "#678335", "#3afd66", "#b9d60d", "#0bc0ff", "#b8559e"];


var constants = {
    touchInteraction:false,
    stdColorScale:d3.scale.ordinal().range(colorD)
};
